(function () {
  ...
  const searchIndex = [
    ...
    { title: "Circle Area Formula", url: "/circle-area-formula/", terms: "circle area formula area of a circle pi r squared radius diameter examples calculator" },
    { title: "Circle Circumference Formula", url: "/circle-circumference-formula/", terms: "circle circumference formula perimeter of circle radius diameter 2 pi r pi d" },
    { title: "Triangle Area Formula", url: "/triangle-area-formula/", terms: "triangle area formula base height one half bh find height from area" },
    { title: "Rectangle Area Formula", url: "/rectangle-area-formula/", terms: "rectangle area formula length times width find width from area" },
    { title: "Square Area Formula", url: "/square-area-formula/", terms: "square area formula side squared find side from area diagonal" },
    { title: "Pythagorean Theorem Formula", url: "/pythagorean-theorem-formula/", terms: "pythagorean theorem formula right triangle hypotenuse missing leg a squared b squared c squared" },
    { title: "Cylinder Volume Formula", url: "/cylinder-volume-formula/", terms: "cylinder volume formula pi r squared h find height radius examples calculator" },
    { title: "Cylinder Surface Area Formula", url: "/cylinder-surface-area-formula/", terms: "cylinder surface area formula total lateral surface area 2 pi r r plus h" },
    { title: "Cone Volume Formula", url: "/cone-volume-formula/", terms: "cone volume formula one third pi r squared h find height radius" },
    { title: "Sphere Volume Formula", url: "/sphere-volume-formula/", terms: "sphere volume formula four thirds pi r cubed radius diameter" },
    { title: "Sphere Surface Area Formula", url: "/sphere-surface-area-formula/", terms: "sphere surface area formula 4 pi r squared find radius" },
    { title: "Rectangular Prism Volume Formula", url: "/rectangular-prism-volume-formula/", terms: "rectangular prism volume formula box volume length width height" },
